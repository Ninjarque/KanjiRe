...
def test_join_by_code_alone_and_play_turns():
    ...
    host.send({"t": "create", "pool": _pool(20),
...
def test_out_of_turn_clicks_are_ignored():
    ...
    host.send({"t": "create", "pool": _pool(12), "faces": ["kanji", "meaning"],
               "board_size": 3, "turns_each": 3})
...
def test_reconnecting_player_resyncs_from_retained_state():
    ...
    host.send({"t": "create", "pool": _pool(16), "faces": ["kanji", "meaning"],
...
def test_wrong_code_reports_not_found():
    ...
    host.send({"t": "create", "pool": _pool(8), "faces": ["kanji", "meaning"],
